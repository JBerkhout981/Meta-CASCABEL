    ...
    with open(snakemake.output[0], "w") as newreportfile:
        ...
        for line in reportfile:
            if line.startswith("body {"):
                newReport = "p.cmmd{ align: left; padding: 10px; border-style:solid; border-color:#99AAC7; max-width:95%; margin-left:2%; height: auto; background-color: #DEDEFF; word-wrap:normal; text-align: left;}\n"
                newReport += line
